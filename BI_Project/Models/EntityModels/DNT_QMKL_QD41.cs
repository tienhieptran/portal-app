...
{
    public class DNT_QMKL_QD41
    {
        public string MA_DVIQLY { get; set; }
        public string TEN_CTRINH { get; set; }
        public int THANG_BC { get; set; }
        public int NAM_BC { get; set; }
        public int SL_CTRINH { get; set; }
        public int DZ_110_UB { get; set; }
        public int DZ_TTHE_UB { get; set; }
        public int SL_TRAM_UB { get; set; }
        public int DL_TBA_UB { get; set; }
        public int DZ_HTHE_UB { get; set; }
        public int NAM_VH_UB { get; set; }
        public int NG_NSNN_UB { get; set; }
        ...
        public int DZ_110_EVN { get; set; }
        public int DZ_TTHE_EVN { get; set; }
        public int SL_TRAM_EVN { get; set; }
        public int DL_TBA_EVN { get; set; }
        ...
        public int XNHAN_EVN { get; set; }
        public int DZ_110_G { get; set; }
        public int DZ_TTHE_G { get; set; }
